...
<small> First Edition: June 1, 2021</small>
</sub>
...
1. Inside 10DaysOfPython create a folder called day_2. Inside this folder create a file named variables.py
2. Write a python comment saying 'Day 2: 10 Days of python programming'
